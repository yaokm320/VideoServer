...
import com.example.entity.vo.PublisherVideoVo;
        ...
        try {
            ...
            if (file != null) {
                ...
                if (StringUtils.isNoneBlank(fileName)) {
                    // 文件上传的最终保存路径
                    String finalFacePath = String.format("/Users/yaokaiming/IdeaProjects/AwesomeVideo/AwesomeVideoUpload/%s/face/%s", userId, fileName);
                    // 设置数据库保存的路径
