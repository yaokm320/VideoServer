...
public class FFmpegUtils {
    ...
    public static void main(String[] args) throws IOException {
        FFmpegUtils ffmpeg = new FFmpegUtils("/usr/local/bin/ffmpeg");
        ffmpeg.mergeVideoAndBackgroundMusic("/Users/yaokaiming/Downloads/movie.mp4",
                "/Users/yaokaiming/Music/网易云音乐/Processional.mp3",
                10,
                "/Users/yaokaiming/Downloads/movie.avi");
    }
